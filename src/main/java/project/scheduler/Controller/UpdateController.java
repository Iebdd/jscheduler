...
/*   private CourseRepository courseRepository;
  ...
  public ResponseEntity<String> setPasswordById(@RequestParam String old_password, @RequestParam String new_password, 
    @RequestParam Integer user_id) {
      ...
      return new ResponseEntity<>(String.format("Saved new password for user: %d%n", user_id), HttpStatus.NO_CONTENT);
  }
