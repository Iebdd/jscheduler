...
import { Course, Room, User, UserToken } from "./interfaces";
...
export class Parse {
    ...
    public static toUserToken(json: string): UserToken {
      return cast(JSON.parse(json), r("UserToken"));
  }
  ...
  const typeMap: any = {
    ...
    "UserToken": o([
        ...
        { json: "userId", js: "userId", typ: "" },
        { json: "check", js: "check", typ: true },
    ], false),
    "Course": o([
      { json: "courseName", js: "courseName", typ: "" },
      { json: "course_id", js: "course_id", typ: "" },
  ], false),
  "Room": o([
